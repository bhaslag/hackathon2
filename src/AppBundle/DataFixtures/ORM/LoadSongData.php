...
class LoadSongData extends AbstractFixture implements \Doctrine\Common\DataFixtures\OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $song3->addTag($this->getReference('tag3'));
        ...
        $song4->addTag($this->getReference('tag4'));
        ...
        $song5->addTag($this->getReference('tag5'));
        ...
        $song6->addTag($this->getReference('tag6'));
        ...
        $song7->addTag($this->getReference('tag7'));
        ...
        $song8->addTag($this->getReference('tag8'));
        ...
        $song9->addTag($this->getReference('tag9'));
